...
import static org.apache.ignite.internal.processors.tracing.SpanType.SQL_QUERY_PARSE;
...
public class QueryParser {
    ...
    public QueryParserResult parse(String schemaName, SqlFieldsQuery qry, boolean remainingAllowed) {
        try (TraceSurroundings ignored = MTC.support(idx.kernalContext().tracing().create(SQL_QUERY_PARSE, MTC.span()))) {
