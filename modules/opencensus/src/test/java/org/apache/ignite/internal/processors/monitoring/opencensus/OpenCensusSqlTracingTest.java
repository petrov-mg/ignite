...
import static org.apache.ignite.internal.processors.tracing.SpanType.SQL_DML_QUERY_EXECUTE;
...
public class OpenCensusSqlTracingTest extends AbstractTracingTest {
    ...
    public void testReducerSkippedUpdate() throws Exception {
        ...
        SpanId dmlExecSpan = checkSpan(SQL_DML_QUERY_EXECUTE, rootSpan);
        ...
        for (int i = 0; i < GRID_CNT; i++) {
            ...
            checkSpan(SQL_ITER_CLOSE, execReqSpans.get(i));
            checkSpan(SQL_DML_QRY_RESP, execReqSpans.get(i));
        }
