...
public class ThreadContextAttributeRegistry {
    ...
    /** */
    public <T> ThreadContextAttribute<T> register(T dfltVal) {
        ThreadContextAttribute<T> attr = new ThreadContextAttribute<>(attrs.size(), dfltVal);
    ...
    /** */
    public Collection<ThreadContextAttribute<?>> attributes() {
