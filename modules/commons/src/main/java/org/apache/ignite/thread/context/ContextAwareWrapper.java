...
/** */
public abstract class ContextAwareWrapper<T> {
    /** */
    protected final T delegate;

    /** */
    protected final ThreadContextSnapshotRecord snapshot;

    /** */
    protected ContextAwareWrapper(T delegate, ThreadContextSnapshotRecord snapshot) {
