...
/** */
public class ContextAwareInClosure<E> extends ContextAwareWrapper<IgniteInClosure<E>> implements IgniteInClosure<E> {
    /** */
    private static final long serialVersionUID = 0L;

    /** */
    public ContextAwareInClosure(IgniteInClosure<E> delegate, ThreadContextSnapshotRecord snapshot) {
    ...
    public static <E> IgniteInClosure<E> wrap(IgniteInClosure<E> delefate) {
        return wrap(delefate, ContextAwareInClosure::new);
    }
