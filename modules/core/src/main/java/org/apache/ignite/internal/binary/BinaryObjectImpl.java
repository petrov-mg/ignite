    ...
    @Nullable @Override public <F> F fieldByOrder(int order) {
        ...
        switch (hdr) {
            ...
            case GridBinaryMarshaller.LOCAL_TIME: {
                long nanoOfDay = BinaryPrimitives.readLong(arr, fieldPos + 1);
            ...
            case GridBinaryMarshaller.LOCAL_DATE: {
                long ofEpochDay = BinaryPrimitives.readLong(arr, fieldPos + 1);

                val = LocalDate.ofEpochDay(ofEpochDay);

                break;
            }

            case GridBinaryMarshaller.LOCAL_DATE_TIME: {
                long epochDay = BinaryPrimitives.readLong(arr, fieldPos + 1);
                long nanoOfDay = BinaryPrimitives.readLong(arr, fieldPos + 1 + 8);
            ...
            case GridBinaryMarshaller.OFFSET_DATE_TIME: {
                int zoneOffsetSeconds = BinaryPrimitives.readInt(arr, fieldPos + 1);
                long epochDay = BinaryPrimitives.readLong(arr, fieldPos + 1 + 4);
                long nanoOfDay = BinaryPrimitives.readLong(arr, fieldPos + 1 + 4 + 8);

                val = OffsetDateTime.of(
                    LocalDateTime.of(
                        LocalDate.ofEpochDay(epochDay), LocalTime.ofNanoOfDay(nanoOfDay)),
