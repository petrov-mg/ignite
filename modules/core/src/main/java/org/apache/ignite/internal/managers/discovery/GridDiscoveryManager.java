...
public class GridDiscoveryManager extends GridManagerAdapter<DiscoverySpi> {
            ...
            class SecurityAwareNotificationTask extends NotificationTask {
                ...
                @Override public void run() {
                    ...
                    if (customMsg instanceof SecurityAwareCustomMessageWrapper) {
                        ...
                        try (ThreadContextScope ignored = ctx.security().withContext(secSubjId)) {
                            super.run();
                        }
                    }
                    else {
                        ...
                        try (ThreadContextScope ignored = ctx.security().withContext(initiatorNodeSecCtx)) {
                            super.run();
                        }
                    }
                }
    ...
    private class DiscoveryWorker extends GridWorker {
        ...
        private void body0() throws InterruptedException {
            ...
            try (ThreadContextScope ignored = withRemoteSecurityContext(ctx, evt.secCtx)) {
                int type = evt.type;
