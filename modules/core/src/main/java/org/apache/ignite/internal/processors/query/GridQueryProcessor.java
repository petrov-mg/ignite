...
public class GridQueryProcessor extends GridProcessorAdapter {
    ...
    public List<FieldsQueryCursor<List<?>>> querySqlFields(
        ...
        MTC.support(CountDownSpan.wrap(ctx.tracing()
            .create(SQL_FIELDS_QUERY_REQUEST, MTC.span())
            .addLog(() -> "SQL query was received [qry=" + qry + ']'), 2));
        ...
        try {
            ...
            List<FieldsQueryCursor<List<?>>> res = executeQuerySafe(cctx, () -> {
                assert idx != null;
            ...
            MTC.span().addLog(() -> "Coursor was returned.");

            return res;
        }
        catch (Exception e) {
            MTC.span().addTag(SpanTags.ERROR, () -> "Failed with exception.");
