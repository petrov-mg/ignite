...
import org.apache.ignite.internal.processors.tracing.TraceFieldsQueryCursor;
...
import static org.apache.ignite.internal.processors.tracing.SpanType.SQL_FIELDS_QUERY_REQUEST;
...
public class GridQueryProcessor extends GridProcessorAdapter {
    ...
    public List<FieldsQueryCursor<List<?>>> querySqlFields(
        ...
        MTC.support(ctx.tracing().create(SQL_FIELDS_QUERY_REQUEST, MTC.span()).addLog(() ->
            "SQL query was received [qry=" + qry + ']'));
                ...
                IgniteOutClosureX<List<FieldsQueryCursor<List<?>>>> clo =
                    new IgniteOutClosureX<List<FieldsQueryCursor<List<?>>>>() {
                        @Override public List<FieldsQueryCursor<List<?>>> applyx() {
                            ...
                            MTC.span().addLog(() -> "Cursor was returned.");

                            res.set(0, new TraceFieldsQueryCursor<>(res.get(0), MTC.span()));
