...
/**
 * Represents wrapper which gives an ability to trace usage of the iterator.
 */
public class TraceableIterator<T> implements Iterator<T> {
    /** Iterator to which all calls will be delegated. */
    private final Iterator<T> iter;

    /** Span in which context iterator should run. */
    private final Span span;

    /**
     * @param iter Iterator to which all calls will be delegated.
     * @param span Span in which context iterator should run.
     */
