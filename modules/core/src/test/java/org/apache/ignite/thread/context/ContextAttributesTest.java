...
public class ContextAttributesTest extends GridCommonAbstractTest {
    ...
    public void testSnapshot() {
        ThreadContextSnapshotRecord snapshot0 = ThreadContext.createSnapshot();
        ThreadContextSnapshotRecord snapshot1;
        ThreadContextSnapshotRecord snapshot2;
        ThreadContextSnapshotRecord snapshot3;
        ThreadContextSnapshotRecord snapshot4;
        ThreadContextSnapshotRecord snapshot5;
        ThreadContextSnapshotRecord snapshot6;
    ...
    public void testCopmpletableFutureContextPropagation() throws Exception {
        ...
        CompletableFuture<String> fut = new ContextAwareCompletableFuture<>();
