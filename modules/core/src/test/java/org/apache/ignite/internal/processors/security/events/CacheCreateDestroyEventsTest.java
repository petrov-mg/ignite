...
public class CacheCreateDestroyEventsTest extends AbstractSecurityTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(
            ...
            new Object[] {6, "new_client_node", EVT_CACHE_STARTED, TestOperation.START_NODE},
            new Object[] {6, "new_server_node", EVT_CACHE_STARTED, TestOperation.START_NODE},
