...
public class AuthenticationConfigurationClusterTest extends GridCommonAbstractTest {
    ...
    public void testServerNodeJoinDisabled() throws Exception {
        checkNodeJoinFailure(false, false);
    }
    ...
    public void testClientNodeJoinDisabled() throws Exception {
        checkNodeJoinFailure(true, false);
    }
    ...
    public void testServerNodeJoinEnabled() throws Exception {
        checkNodeJoinFailure(false, true);
    }
    ...
    public void testClientNodeJoinEnabled() throws Exception {
        checkNodeJoinFailure(true, true);
    }
     ...
     * @throws Exception If failed.
     */
    private void checkNodeJoinFailure(boolean client, boolean authEnabled) throws Exception {
    ...
    public void testDisabledAuthentication() throws Exception {
        ...
        checkSecurityOperationFailure(() -> createUser(grid(0), null, "test", "test"));
        checkSecurityOperationFailure(() -> dropUser(grid(0), null, "test"));
        checkSecurityOperationFailure(() -> alterUserPassword(grid(0), null, "test", "test"));
    }

    /* Checks that specified security operation fails * */
    @SuppressWarnings("ThrowableNotThrown")
    private void checkSecurityOperationFailure(IgniteThrowableRunner op) {
    ...
    public void testBothAuthenticationAndSecurityPluginConfiguration() {
        GridTestUtils.assertThrowsAnyCause(log, () -> {
            ...
            IgniteCheckedException.class,
            "Invalid security configuration: both internal authentication is enabled and security plugin is provided.");
    }
}
